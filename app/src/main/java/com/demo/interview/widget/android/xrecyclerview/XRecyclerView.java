...
import static com.demo.interview.widget.android.xrecyclerview.BaseRefreshHeader.STATE_DONE;
...
public class XRecyclerView extends RecyclerView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mLayouttype = a.getInteger(R.styleable.XRecyclerView_pullhead, 1);
            if (mLayouttype != 2) {
                mLayouttype = ArrowRefreshHeader.LAYOUTTYPE_DEFAULT;
            }
        }
        if (pullRefreshEnabled) {
            mRefreshHeader = new ArrowRefreshHeader(getContext(), mLayouttype);
...
//                Log.e("当前滚动","---："+deltaY);
    ...
    public void setScollChangeListener(ArrowRefreshHeader.onStateChange changeListener) {
        if (mRefreshHeader != null) {
            mRefreshHeader.setStatusListener(changeListener);
        }
    }
